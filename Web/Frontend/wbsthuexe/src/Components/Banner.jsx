                ...
                <div className=' p-5 w-full md:w-[80%]    '>
                    {
                        state===1? ( <div className=' flex flex-col gap-4 justify-stretch w-full h-auto items-start text-xs '>
                           <h1 className='md:text-xl  font-light'> Chúng tôi là <span className="font-bold">MOTOVIP®</span></h1>
                            <h1 className='md:text-5xl  font-extrabold  leading-tight'> Đơn vị cho thuê xe máy  <br/> uy tín tại Việt Nam</h1>
                            <h1 className='mt-4  py-2  text-white  md:text-lg'>MOTOVIP cam kết mang đến dịch vụ cho thuê xe máy chuyên nghiệp, đáng tin cậy cho khách hàng.</h1>

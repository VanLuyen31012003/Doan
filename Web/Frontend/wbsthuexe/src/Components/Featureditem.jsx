  ...
  return (
    <div className="  ">
      <div className=" w-full  mt-[10%] bg-[#f9f9f9] md:mt-[40%] ">
        ...
        <h1 className="text-[#DD5C36] text-4xl text-center font-bold">Top xe thông dụng</h1>
        ...
        <div className="mt-[30px] flex md:flex-row flex-col w-full  gap-4 overflow-x-auto scroll-container ">
            {products?.map((item, index) => (
              <Link to="/chitietsp" className=" duration-300 min-w-[250px]  md:min-w-[300px] snap-start flex flex-col gap-3 bg-white text-[#555555] shadow-lg rounded py-4">
                   <div key={index} className=" flex flex-col gap-3 bg-white  text-[#555555] shadow-lg rounded py-4">
              <img src={item.anhDefault ?? "https://phuongxe.vn/wp-content/uploads/2020/06/wave-thai-trang.jpg"} alt=""/>
